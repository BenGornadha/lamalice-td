...
class WaveAnnouncer:
    ...
    def display_wave_announcement(self, wave_number : int):
    ...
    def run(self, show_wave_announcement: bool, wave_current_index: int, current_time: int) -> None:
        ...
        if self._show_wave_announcement_4_secs(current_time=current_time):
            self.display_wave_announcement(wave_number=wave_current_index)
    ...
    def _show_wave_announcement_4_secs(self, current_time: int) -> bool:
        return current_time - self.wave_announcement_time < 4000

    def _show_first_ever_wave_announcement_2_secs(self, current_time: int) -> bool:
        return current_time - self.first_ever_wave_time < 4000
